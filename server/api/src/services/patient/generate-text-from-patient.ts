...
export const generateTextFromPatient = async (
  ...
  return `
    Patient Name: Juan Carlos Rodriguez
    Date of Visit: March 1, 2023
    Chief Complaint: Memory problems
    History of Present Illness:
    Juan Carlos Rodriguez is a 65-year-old male who presents to the memory clinic with complaints of memory problems. He reports that he has been having difficulty remembering recent events, such as where he put his keys or what he had for breakfast. He also states that he has been having trouble concentrating and feels easily distracted.
    Past Medical History:
    Juan Carlos Rodriguez has a history of hypertension, hyperlipidemia, and type 2 diabetes mellitus. He takes medications for these conditions, including lisinopril, atorvastatin, and metformin.
    Family History:
    Juan's father had Alzheimer's disease.
    Social History:
    Juan Carlos Rodriguez is retired and lives with his wife. He does not smoke or drink alcohol.
    ...
    Assessment and Plan:
    Based on the patient's complaints and family history, we suspect that Juan Carlos Rodriguez may have mild cognitive impairment or early-stage Alzheimer's disease. We plan to order further testing, including cognitive testing and brain imaging, to help confirm the diagnosis. We will also provide John Doe with education about the disease process, support for him and his family, and referrals to community resources for additional assistance. We will schedule a follow-up appointment to review the test results and discuss further management options.
  `;
};
